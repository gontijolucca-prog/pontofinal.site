...
export default function Contrato() {
  ...
  return (
    <div>
      ...
      <div
        id="contrato-container"
        className="a4-container"
        style={{ flexDirection: 'column', alignItems: 'center', gap: '2rem', paddingTop: '1.5rem' }}
      >
        ...
        <div className="a4-page brutal-card-static" style={{ boxShadow: 'none' }}>
          ...
          <section style={{ marginTop: '1.5rem', fontSize: '0.82rem', lineHeight: '1.6' }}>
            ...
            <div style={{ marginBottom: '1.2rem' }}>
              ...
              ><strong>E:</strong></p>
                ...
                <div style={{ border: '2px solid #050505', padding: '0.8rem', marginBottom: '0.8rem' }}>
                  <p style={{ fontWeight: 900, textTransform: 'uppercase', fontSize: '0.75rem', marginBottom: '0.5rem' }}>Dados do Cliente</p>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem 1rem' }}>
                    {[
                      ...
                      'Com poderes para o ato (cargo)',
                    ].map((label) => (
                      <div key={label} style={{ gridColumn: label === 'Sede / Morada' || label === 'Representada por (nome da pessoa)' || label === 'Com poderes para o ato (cargo)' ? 'span 2' : 'auto' }}>
                        ...
                        {editMode ? (
                          <input
                            ...
                            style={{
                              border: 'none',
                              borderBottom: '1.5px solid #050505',
                              minWidth: '150px',
                              width: '60%',
                  ...
                  <p
                    ...
                    contentEditable={editMode}
                    suppressContentEditableWarning
                  >doravante designado(a) por <strong>CLIENTE</strong>.</p>
                </div>
            ...
            {[
              ...
              },
              {
                ...
                items: [
                  'Conteúdos do CLIENTE: O domínio, logótipos, marcas, textos e imagens fornecidos pelo CLIENTE são e permanecem sua propriedade exclusiva.',
                   'Conteúdos produzidos pelo PRESTADOR: Posts, carrosseis, <VideoTooltip>vídeos</VideoTooltip> e legendas criados tornam-se propriedade do CLIENTE após o pagamento integral da mensalidade. O PRESTADOR pode usá-los no seu portfólio.',
              ...
              <div key={clause.num} style={{ marginBottom: '0.7rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
            ...
            <div style={{ marginTop: '1.2rem', borderTop: '2px solid #050505', paddingTop: '0.8rem' }}>
              <p
                ...
                suppressContentEditableWarning
              >
                Feito em duplicado em ____________________, aos ____ de __________________ de ______.
              </p>
        ...
        <div className="a4-page brutal-card-static" style={{ boxShadow: 'none', pageBreakBefore: 'always', breakBefore: 'page' }}>
          <header className="proposta-header shrink-0">
            <h1 className="proposta-title" style={{ fontSize: '1.6rem' }} contentEditable={editMode} suppressContentEditableWarning>ANEXO A</h1>
            <p className="proposta-subtitle" contentEditable={editMode} suppressContentEditableWarning>Dados do Cliente e Planos Contratados</p>
          </header>

          <section style={{ marginTop: '1rem', fontSize: '0.82rem', lineHeight: '1.6' }}>

            {/* DADOS DO CLIENTE */}
            <div style={{ marginBottom: '1rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
            ...
            <div style={{ marginBottom: '1rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={label} style={{ borderBottom: '1px solid #ccc' }}>
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{label}</td>
              ...
              <div style={{ marginBottom: '0.4rem' }}>
                ...
                <label style={{ fontSize: '0.75rem', fontWeight: 600 }}><input type="checkbox" /> Anual (oferta 4 últimos meses)</label>
              </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={fase} style={{ borderBottom: '1px solid #ccc' }}>
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{fase}</td>
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{prazo}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <tbody>
                  {[
                    ...
                    '🥈 Prata — 28 posts · 4/sem · 3 carrosseis/sem · planeamento',
                     '🥇 Ouro — 36 posts · 5/sem · 4 carrosseis · 1 <VideoTooltip>vídeo</VideoTooltip>/sem · métricas',
            ...
            <div style={{ marginBottom: '1rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
              ...
              <ul style={{ paddingLeft: '1.2rem', fontSize: '0.75rem', margin: 0 }}>
                {[
                  ...
                  <li key={item} style={{ marginBottom: '0.15rem' }} contentEditable={editMode} suppressContentEditableWarning>{item}</li>
                ))}
              </ul>
            </div>
                ...
                <tbody>
                  {[['Website', '', '___€', '___€/mês'], ['Conteúdo', '', '—', '___€/mês']].map(([serv, plano, setup, mens]) => (
                    <tr key={serv} style={{ borderBottom: '1px solid #ccc' }}>
                      ...
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{plano}</td>
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{setup}</td>
                      <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>{mens}</td>
                    </tr>
                  ))}
                  <tr style={{ borderTop: '2px solid #050505', fontWeight: 900 }}>
                    ...
                    <td style={{ padding: '0.3rem 0.5rem' }} contentEditable={editMode} suppressContentEditableWarning>___€/mês</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div style={{ marginBottom: '1rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
              ...
              <div style={{ marginBottom: '0.4rem' }}>
                ...
                {editMode ? (
                  <>
                    <input type="text" style={{ display: 'block', border: 'none', borderBottom: '1.5px solid #050505', marginTop: '0.3rem', marginBottom: '0.3rem', width: '100%', background: 'transparent', fontFamily: 'inherit', fontSize: '0.75rem', outline: 'none' }} placeholder="____________________" />
                    <input type="text" style={{ display: 'block', border: 'none', borderBottom: '1.5px solid #050505', marginBottom: '0.3rem', width: '100%', background: 'transparent', fontFamily: 'inherit', fontSize: '0.75rem', outline: 'none' }} placeholder="____________________" />
                  </>
                ) : (
                  <>
              ...
              <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', marginBottom: '0.4rem', flexWrap: 'wrap' }}>
                <div>
                  ...
                  {editMode ? (
                    <input type="text" style={{ border: 'none', borderBottom: '1.5px solid #050505', minWidth: '80px', background: 'transparent', fontFamily: 'inherit', fontSize: '0.75rem', outline: 'none' }} placeholder="___" />
                  ) : (
              ...
              <div>
                ...
                {editMode ? (
                  <>
                    <input type="text" style={{ display: 'block', border: 'none', borderBottom: '1.5px solid #050505', marginTop: '0.3rem', marginBottom: '0.3rem', width: '100%', background: 'transparent', fontFamily: 'inherit', fontSize: '0.75rem', outline: 'none' }} placeholder="____________________" />
                    <input type="text" style={{ display: 'block', border: 'none', borderBottom: '1.5px solid #050505', width: '100%', background: 'transparent', fontFamily: 'inherit', fontSize: '0.75rem', outline: 'none' }} placeholder="____________________" />
                  </>
                ) : (
                  <>
                    <span style={{ display: 'block', borderBottom: '1.5px solid #050505', marginTop: '0.3rem', marginBottom: '0.3rem', minHeight: '1.2rem' }}></span>
            ...
            {/* ASSINATURAS ANEXO */}
            <div style={{ borderTop: '2px solid #050505', paddingTop: '0.8rem', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
              <p style={{ fontSize: '0.75rem', marginBottom: '0.6rem' }}
                contentEditable={editMode} suppressContentEditableWarning>
                O CLIENTE declara ter lido e aceite o presente Anexo.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  <p style={{ fontWeight: 900, fontSize: '0.75rem', textTransform: 'uppercase', marginBottom: '0.3rem' }}>PRESTADOR</p>
                  ...
                  <p style={{ fontSize: '0.72rem', marginBottom: 0 }}
                    contentEditable={editMode} suppressContentEditableWarning>
                ...
                <div>
                  <p style={{ fontWeight: 900, fontSize: '0.75rem', textTransform: 'uppercase', marginBottom: '0.3rem' }}>CLIENTE</p>
                  <div style={{ borderBottom: '1.5px solid #050505', marginBottom: '0.3rem', minHeight: '2rem' }}></div>
                  <p style={{ fontSize: '0.72rem', marginBottom: '0.2rem' }}
                    contentEditable={editMode} suppressContentEditableWarning>
